...
class UpdateVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        // O sometimes deixa faz que o campo não precise necessariamente ser enviado com a requisição. Mas, se for enviado, é validado de acordo com as regras definidas.
